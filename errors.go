...
var (
	...
	ErrInvalidHostAddress    = errors.New("invalid address for host")
	ErrInvalidRegisteredName = errors.New("invalid host (registered name)")
	ErrInvalidDNSName        = errors.New("invalid host (DNS name)")
)
